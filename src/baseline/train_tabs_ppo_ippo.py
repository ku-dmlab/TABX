...
class Config:
    ...
    wandb_project: str = "tabs_at_ppo_ippo"
    debug: bool = False
...
if __name__ == "__main__":
    ...
    ippo_bs = IPPO(config.ippo, env_bs)
    ...
    train_state_bs = ippo_bs.init_train_state(
    ...
    def train_bs(carry, _):
        ...
        train_state_bs, train_info_bs = ippo_bs.train(
    ...
    for step in tqdm(range(config.total_train_iter)):
        ...
        ippo_bs.save_state(carry[2], os.path.join(config.save_path, f"bs/ippo/{step}"))

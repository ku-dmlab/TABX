...
def make_train(config, env, env_params, test_env_params):
    ...
    def train(rng):
        ...
        def create_agent(rng):
            init_x = (
                jnp.zeros((1, 1, env.world_state_size())),  # (time_step, batch_size, obs_size)
            ...
            state_size = sample_traj.obs["world_state"].shape[
                -1
        ...
        def _update_step(runner_state, unused):
            ...
            def _step_env(carry, _):
                ...
                _obs = jnp.tile(last_obs["world_state"], (env.num_agents, 1, 1))[:, np.newaxis]
            ...
            def _learn_phase(carry, _):
                ...
                _obs = jnp.tile(minibatch.obs["world_state"], (env.num_agents, 1, 1, 1))

...
from src.environments.physics import Transform, RigidBody, CircleCollider, physics_step
...
class PygameRenderer:
    ...
    def draw_ui(self, objects):
        ...
        env_time_text = self.small_font.render(
            f"Env Time: {env_time:.1f}s (dt={self.env_dt}, step={self.env_timestep})",
            True,
            (100, 255, 100),
        )
